...
U trećem je retku niz od $K$ različitih 
prirodnih brojeva između $1$ i $N$, 
koji predstavlja zadani skup brojeva. 
...
Pri tome, stanje ploče smatramo \textit{mogućim} ukoliko se ono može pojaviti 
u tijeku igre. 
